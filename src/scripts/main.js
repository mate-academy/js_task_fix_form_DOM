...
for (let i = 0; i < fieldInputs.length; i++) {
  ...
  label.textContent = fieldInputs[i]
    .getElementsByClassName('field-text')[0].name
    .split('')
  ...
  fieldInputs[i].getElementsByClassName('field-text')[0].placeholder
    = label.textContent[0].toLocaleUpperCase() + label.textContent.slice(1);
}
